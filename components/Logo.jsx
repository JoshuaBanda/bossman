...
const page = ({ restaurantName = 'Restaurant' }) => {
    ...
    useLayoutEffect(() => {
        ...
        letters.forEach((letter, i) => {
            ...
            const length = letter.getComputedTextLength();
            ...
            // animate handwriting effect
            gsap.to(letter, {
                strokeDashoffset: 0,   // ✅ reveal stroke fully
                duration: 0.5,
                delay: i * 0.3,        // stagger letters
                ease: "power2.inOut",
                onComplete: () => {
                    gsap.to(letter, { fill: "white", duration: 0.5 });
                },
            });
        });
    }, []);
            ...
            <div className={styles.logoSubContainer}>
                ...
                <div className={styles.shapes}>
                    ...
                    <div className={styles.folkAndSpoons}>
                        <div className={styles.folkContainer}>
                        ...
                        <div className={styles.spoonContainer}>
                            <svg width="100%" height="100%" viewBox="0 0 1080 1080">
                ...
                <div className={styles.cup}>
                    <svg width="100%" height="100%" viewBox="0 0 1080 1080">
                        ...
                        <path id="cup" d="M686.318,972.958s-50.712,12.606-99.706,13.752-112.6.573-147.841-3.438-48.134-10.314-48.134-10.314V962.643s91.111-13.18,110.021-37.82,20.629-20.629,20.629-20.629,17.191-271.041,3.438-302.558-15.472-35.527-37.82-51.572S383.761,480.155,380.322,412.538,397.513,186.192,414.7,127.171s3.438-10.315,3.438-10.315l3.438-24.067h233.8s44.7,193.683,44.7,254.424S692.049,453.8,658.813,488.177,606.1,544.334,590.05,553.5s-37.82,48.134-37.82,48.134-12.033,284.222,3.438,299.12,17.191,24.067,17.191,24.067,55.011,26.36,82.516,30.944,30.943,6.876,30.943,6.876v10.315Z" />
                    </svg>
